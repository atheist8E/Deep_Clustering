...
def set_args():
	...
	parser.add_argument("--description",        						type = str,        default = "K Means")
...
if __name__ == "__main__":
	...
	with open(os.path.join(result_path, "Experiment_Description.txt"), "w") as f:
		...
		dataset = pd.read_csv(os.path.join(os.path.join(args.source_path, "normalized"), "Credit.csv"))
		print(dataset)
		...
		predictions = model.fit_predict(dataset[args.numerical_features].to_numpy())
